...
import MoreDetails9 from './pages/MoreDetails9';
 ...
 function Box() {
  return (
    <div className=' flex-row  flex-wrap space-x-10 items-center grid grid-cols-3 gap-4 '>
     <article className="bg-white border-8 border-violet-600 rounded-lg shadow-md p-4 w-96 h-96 grid gap-x-8 gap-y-4 grid-cols-1 ms-40 max-w-64 max-h-64 mt-10 transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110 hover:bg-gray-300 duration-300 ...">
        <time className='font-bold text-[36px] text-center'>1:00PM</time>
        <h2 className='font-bold text-[22px]'>CLASS NAME 01 </h2>
        <p>Mode: ON/OFF <br />
        No. of students :</p>
        <button type='button ' className='border ring-stone-100 bg-[#2f2e67] text-white hover:bg-slate-500 '>
     ...
     <div>
     <article className="bg-white  border-8 border-violet-600 rounded-lg shadow-md p-4 w-96 h-96 grid gap-x-8 gap-y-4 grid-cols-1 ms-20 max-w-64 max-h-64 mt-10 transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110 hover:bg-gray-300 duration-300 ...">
    ...
    <div>
     <article className="bg-white  border-8 border-violet-600 rounded-lg shadow-md p-4 w-96 h-96 grid gap-x-8 gap-y-4 grid-rows-2 ms-10 max-w-64 max-h-64 mt-10  transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110 hover:bg-gray-300 duration-300 ...">
    ...
    <div className='flex flex-wrap'>
     <article className="bg-white border-8 border-violet-600 rounded-lg shadow-md p-4 w-96 h-96 grid gap-x-8 gap-y-3 grid-cols-1 ms-[115px] max-w-64 max-h-64 mt-10 transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110 hover:bg-gray-300 duration-300 ...">
    ...
    <div>
     <article className="bg-white border-8 border-violet-600 rounded-lg shadow-md p-4 w-96 h-96 grid gap-x-8 gap-y-4 grid-cols-1 ms-10 max-w-64 max-h-64 mt-10 transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110 hover:bg-gray-300 duration-300 ...">
