...
<h1 className='text-left mt-10 text-4xl flex '> <IoTime className='mr-4'/><u>Time</u>: 7:00 PM </h1>
<h1 className='text-left mt-10 text-4xl flex'> <MdOutlineDateRange className='mr-4'/><u>Date</u>: 29th Sept 2024</h1>
<h2 className='text-left mt-10 text-4xl flex'><RiVidiconLine className='mr-4'/><u>Mode</u>: Online</h2>
<h2 className='text-left mt-10 text-4xl flex'><IoPeople className='mr-4'/><u>Number Of Students</u>: 18</h2>
